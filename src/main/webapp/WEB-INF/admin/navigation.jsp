<%@ page language="java" contentType="text/html; charset=UTF-8"
         pageEncoding="UTF-8"%>
<!-- Navigation -->
<div class="navbar navbar-fixed-top scroll-hide" style="position: absolute;">
        ...
        <div class="pull-right">
            <ul class="nav navbar-nav pull-right">
                ...
                <li class="dropdown user hidden-xs"><a data-toggle="dropdown" class="dropdown-toggle" href="#">
                    <img width="34" height="34" src="${pageContext.request.contextPath}/resources/admin/images/avatar-male.jpg" />${loginAdmin.name}<b class="caret"></b></a>
                    <ul class="dropdown-menu">
                        <li><a href="${pageContext.request.contextPath}/admin/admin/show/${loginAdmin.a_id}">
                            <i class="icon-user"></i>我的账户</a>
                        </li>
                        <li><a href="${pageContext.request.contextPath}/admin/admin/saveUI/${loginAdmin.a_id}">
                            <i class="icon-gear"></i>账户设置</a>
                        </li>
                        <li><a href="${pageContext.request.contextPath}/admin/admin/logout">
