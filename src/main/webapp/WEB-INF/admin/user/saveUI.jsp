                ...
                <form action="${pageContext.request.contextPath}/admin/user/${ user.u_id == null ? 'add' : 'update' }" id="user-form" method="post" class="form-horizontal" role="form">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" ${ admin.account == null ? 'add' : 'readonly' } id="name" name="name" class="col-xs-10 col-sm-5" value="${user.name} "/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <textarea id="introduction" name="introduction"
                                          class="col-xs-10 col-sm-5" value="${user.introduction}"></textarea>
                            </div>
                        </div>
