        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="table-header">
                    datatables
                    <a class="btn btn-sm btn-primary-outline pull-right col-xs-1" href="${pageContext.request.contextPath}/admin/goods_type/saveUI" id="add-row"><i class="glyphicon glyphicon-plus"></i> 添加</a>　　
                </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var oTable= $("#datatable-editable").dataTable({
            ...
            "sAjaxSource": "${pageContext.request.contextPath}/admin/goods_type/dataTable",//这个是请求的地址
...
// 3个参数的名字可以随便命名,但必须是3个参数,少一个都不行
        ...
        $('#datatable-editable').on('click', 'a.delete-row', function (e) {
            ...
            $.post("${pageContext.request.contextPath}/admin/goods_type/delete/"+id, function(result){
                if(result.success){
