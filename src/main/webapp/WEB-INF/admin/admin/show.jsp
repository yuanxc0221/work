                ...
                <form class="form-horizontal">
                    <fieldset>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" readonly id="account" name="account" class="col-xs-10 col-sm-5" value="${admin.account}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="name"> 姓名 </label>
                            <div class="col-sm-9">
                                <input type="text" id="name" name="name" readonly value="${admin.name}" class="col-xs-10 col-sm-5"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="phoneNumber" name="phoneNumber"
                                       class="col-xs-10 col-sm-5" readonly value="${admin.phoneNumber}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="email" id="email" name="email"
                                       class="col-xs-10 col-sm-5" readonly value="${admin.email}"/>
                            </div>
                        </div>
