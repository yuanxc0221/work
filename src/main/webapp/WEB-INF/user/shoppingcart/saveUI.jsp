                ...
                <form action="${pageContext.request.contextPath}/user/ShoppingCart/update" id="shoppingcart-form" method="post" class="form-horizontal" role="form" enctype="multipart/form-data" >
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="text" id="name" name="name" disabled class="col-xs-10 col-sm-5" value="${shoppingcart.goods.name}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="money"> 商品单价 </label>
                            <div class="col-sm-9">
                                <input type="text" id="money" name="money" disabled class="col-xs-10 col-sm-5" value="${shoppingcart.goods.money}"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label no-padding-right" for="piece"> 购买件数 </label>
                            <div class="col-sm-9">
                                <textarea id="piece" name="piece"
                                            class="col-xs-10 col-sm-5" type="text">${shoppingcart.piece}</textarea>
                            </div>
                        </div>
